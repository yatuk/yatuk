...
<p><img src="https://img.shields.io/badge/BDDK-Regulatory_Awareness-0D1117?style=for-the-badge" alt="BDDK"/> <img src="https://img.shields.io/badge/ISO%2FIEC_27001-Awareness-00B4D8?style=for-the-badge" alt="ISO 27001"/></p>
...
|---|---|---|
| 🛡️ **[Tamga](https://github.com/yatuk/tamga)** ⭐34 | Self-hosted proxy that redacts PII, blocks leaked secrets, and catches prompt injection before it hits your LLM provider. Sub-millisecond scanning, KVKK/BDDK/GDPR/PCI-DSS mappings. | `Go` `Python` `Next.js` |
...
| 🎓 **[İTÜ MCP](https://github.com/yatuk/itu-mcp)** ⭐8 | MCP server that connects İTÜ's Ninova and OBS to Claude, Cursor, and other AI clients. Course files, grades, deadlines, transcript, all queryable in plain language. | `Python` `FastMCP` |
| 🗂️ **[İTÜ Archive](https://github.com/yatuk/itu-archive)** ⭐2 | OBS only keeps the current term online, so this pulls the course schedule and academic calendar daily and keeps it. 27 terms, 64k+ section records since 2016. | `Go` `JSON/CSV` |
...
| 📡 **[MCPRadar](https://github.com/yatuk/mcpradar)** ⭐3 | Scans MCP servers for tool poisoning, prompt injection, and supply-chain rug pulls before your agent runs them. SARIF output, [public leaderboard](https://yatuk.github.io/mcpradar). | `Python` |
